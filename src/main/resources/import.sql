...
/*
insert into lote (codigo, estoque, data, id_creatina) values('1111', 10, '2024-11-07', 1);
insert into lote (codigo, estoque, data, id_creatina) values('1112', 5, '2024-11-06', 1);

insert into lote (codigo, estoque, data, id_creatina) values('2221', 15, '2024-11-07', 1);
insert into lote (codigo, estoque, data, id_creatina) values('2222', 10, '2024-11-06', 1);
*/
